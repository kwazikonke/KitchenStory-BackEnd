...
import com.service.PurchaseItemService;
...
public class CartController {
	...
	public String cartAddItem(@PathVariable Long productId, HttpServletRequest request) {
	...
	@SuppressWarnings("unchecked")
	@GetMapping("/cart")
	public String viewCart(ModelMap map,HttpServletRequest request) {
